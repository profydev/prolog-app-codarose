describe("Sidebar Navigation", () => {
  ...
  context("desktop resolution", () => {
    ...
    it("links are working", () => {
      ...
      cy.get("nav").contains("Docs").should("have.attr", "href", "/dashboard#");
      cy.get("nav").contains("API").should("have.attr", "href", "/dashboard#");
      cy.get("nav").contains("Help").should("have.attr", "href", "/dashboard#");
      cy.get("nav")
        .contains("Community")
        .should("have.attr", "href", "/dashboard#");
    });
    ...
    it("is collapsible", () => {
      ...
      cy.get("nav").find("a").should("have.length", 9).eq(1).click();
  ...
  context("mobile resolution", () => {
    ...
    it("toggles sidebar navigation by clicking the menu icon", () => {
      ...
      cy.get("nav").find("a").should("have.length", 9);
